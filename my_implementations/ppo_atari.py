...
def parse_args():
    ...
    parser.add_argument('--total_timesteps', type=int, default=10_000_000,
                        help='the timesteps of the experiments')
    ...
    parser.add_argument('--wandb_project_name', type=str, default='cleanRL',
                        help='the wandbs\'s project name')
    parser.add_argument('--wandb_entity', type=str, default=None,
                        help='the enetity (team) of wandb\'s project')
    parser.add_argument('--capture_video', type=lambda x: bool(strtobool(x)), default=False, nargs='?', const=True,
                        help='whether to capture video of the agent performances')
...
if __name__ == '__main__':
    ...
    print('envs.single_action-space.n', envs.single_action_space.n)
    ...
    print(num_updates)
    print('agent.network', agent.network(next_obs).shape)
    ...
    print('agent.get_action_and_next_value(next_obs)', agent.get_action_and_value(next_obs))
    ...
    for update in range(1, num_updates + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            for i in range(args.num_envs):
                ...
                if done[i]:
                    print(
                        f"global_step={global_step}, env={i}, episodic_return={episode_rewards[i]:.2f}, episodic_length={episode_lengths[i]}")
                    writer.add_scalar(f"charts/episodic_return_env{i}", episode_rewards[i], global_step)
                    writer.add_scalar(f"charts/episodic_length_env{i}", episode_lengths[i], global_step)
                    episode_rewards[i] = 0
                    episode_lengths[i] = 0
